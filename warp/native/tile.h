...
inline CUDA_CALLABLE TileX& tile_cholesky_solve(Fwd fun_forward, TileL& L, TileY& Y, TileX& X)
{
    // Copy y to x
...
inline CUDA_CALLABLE void tile_cholesky_solve_inplace(Fwd fun_forward, TileL& L, TileY& Y)
{
#if !defined(__CUDA_ARCH__) || WP_ENABLE_MATHDX == 0
