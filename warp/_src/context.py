...
# WARP_ENABLE_MEMPOOLS_AT_INIT=0 overrides warp.config.enable_mempools_at_init at
# import time. Set this when using Warp alongside GPU allocators that conflict with
# Warp memory pools (e.g. some PyTorch-ROCm configurations).
